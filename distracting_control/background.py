...
class DistractingBackgroundEnv(control.Environment, SaveMixin):
    ...
    **NOTE**: This wrapper should be applied BEFORE the pixel wrapper to make sure
    ...
    :param env:
    :param dataset_path:
    :param dataset_videos:
    :param video_alpha:
    :param ground_plane_alpha:
    :param num_videos:
    :param dynamic: bool: Whether to use a video as background
    :param seed:
